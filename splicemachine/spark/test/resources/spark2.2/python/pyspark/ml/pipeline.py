...
class Pipeline(Estimator, MLReadable, MLWritable):
    ...
    def _to_java(self):
        ...
        _java_obj = JavaParams._new_java_obj("org.apache.spark.mlmanager.Pipeline", self.uid)
...
class PipelineModel(Model, MLReadable, MLWritable):
    ...
    def _to_java(self):
        ...
        _java_obj =\
            JavaParams._new_java_obj("org.apache.spark.mlmanager.PipelineModel", self.uid, java_stages)
