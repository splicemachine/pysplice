...
class ParamGridBuilder(object):
    ...
    >>> from pyspark.mlmanager.classification import LogisticRegression
...
class CrossValidator(Estimator, ValidatorParams):
    ...
    >>> from pyspark.mlmanager.classification import LogisticRegression
    >>> from pyspark.mlmanager.evaluation import BinaryClassificationEvaluator
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder\
        .master("local[2]")\
        .appName("mlmanager.tuning tests")\
        .getOrCreate()
