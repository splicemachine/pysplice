...
class GaussianMixture(JavaEstimator, HasFeaturesCol, HasPredictionCol, HasMaxIter, HasTol, HasSeed,
    ...
    def __init__(self, featuresCol="features", predictionCol="prediction", k=2,
        ...
        self._java_obj = self._new_java_obj("org.apache.spark.mlflow_support.clustering.GaussianMixture",
                                            self.uid)
...
class KMeans(JavaEstimator, HasFeaturesCol, HasPredictionCol, HasMaxIter, HasTol, HasSeed,
    ...
    def __init__(self, featuresCol="features", predictionCol="prediction", k=2,
        ...
        self._java_obj = self._new_java_obj("org.apache.spark.mlflow_support.clustering.KMeans", self.uid)
...
class BisectingKMeans(JavaEstimator, HasFeaturesCol, HasPredictionCol, HasMaxIter, HasSeed,
    ...
    def __init__(self, featuresCol="features", predictionCol="prediction", maxIter=20,
        ...
        self._java_obj = self._new_java_obj("org.apache.spark.mlflow_support.clustering.BisectingKMeans",
                                            self.uid)
...
class LDA(JavaEstimator, HasFeaturesCol, HasMaxIter, HasSeed, HasCheckpointInterval,
    ...
    :py:class:`pyspark.mlflow_support.feature.Tokenizer` and :py:class:`pyspark.mlflow_support.feature.CountVectorizer`
    can be useful for converting text to word count vectors.

    >>> from pyspark.mlflow_support.linalg import Vectors, SparseVector
    >>> from pyspark.mlflow_support.clustering import LDA
    ...
    def __init__(self, featuresCol="features", maxIter=20, seed=None, checkpointInterval=10,
        ...
        self._java_obj = self._new_java_obj("org.apache.spark.mlflow_support.clustering.LDA", self.uid)
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder\
        .master("local[2]")\
        .appName("mlflow_support.clustering tests")\
        .getOrCreate()
