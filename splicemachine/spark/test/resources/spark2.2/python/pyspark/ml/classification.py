...
class JavaClassificationModel(JavaPredictionModel):
    ...
    To be mixed in with class:`pyspark.mlmanager.JavaModel`
    """
...
class LinearSVC(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol, HasMaxIter,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.LinearSVC", self.uid)
...
class LogisticRegression(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol, HasMaxIter,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.LogisticRegression", self.uid)
...
class DecisionTreeClassifier(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol,
    ...
    >>> from pyspark.mlmanager.linalg import Vectors
    >>> from pyspark.mlmanager.feature import StringIndexer
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.DecisionTreeClassifier", self.uid)
...
class RandomForestClassifier(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol, HasSeed,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.RandomForestClassifier", self.uid)
        self._setDefault(maxDepth=5, maxBins=32, minInstancesPerNode=1, minInfoGain=0.0,
                         maxMemoryInMB=256, cacheNodeIds=False, checkpointInterval=10,
...
class GBTClassifier(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol, HasMaxIter,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.GBTClassifier", self.uid)
        self._setDefault(maxDepth=5, maxBins=32, minInstancesPerNode=1, minInfoGain=0.0,
                         maxMemoryInMB=256, cacheNodeIds=False, checkpointInterval=10,
...
class NaiveBayes(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol, HasProbabilityCol,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.NaiveBayes", self.uid)
...
class MultilayerPerceptronClassifier(JavaEstimator, HasFeaturesCol, HasLabelCol, HasPredictionCol,
    ...
    def __init__(self, featuresCol="features", labelCol="label", predictionCol="prediction",
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.mlmanager.classification.MultilayerPerceptronClassifier", self.uid)
...
class OneVsRest(Estimator, OneVsRestParams, MLReadable, MLWritable):
    ...
    def _to_java(self):
        ...
        """
        _java_obj = JavaParams._new_java_obj("org.apache.spark.mlmanager.classification.OneVsRest",
                                             self.uid)
...
class OneVsRestModel(Model, OneVsRestParams, MLReadable, MLWritable):
    ...
    def _to_java(self):
        ...
        _java_obj = JavaParams._new_java_obj("org.apache.spark.mlmanager.classification.OneVsRestModel",
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder\
        .master("local[2]")\
        .appName("mlmanager.classification tests")\
        .getOrCreate()
