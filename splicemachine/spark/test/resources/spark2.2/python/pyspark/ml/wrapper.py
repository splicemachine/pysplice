...
class JavaParams(JavaWrapper, Params):
    ...
    def _transfer_param_map_to_java(self, pyParamMap):
        ...
        """
        paramMap = JavaWrapper._new_java_obj("org.apache.spark.mlmanager.param.ParamMap")
        for param in self.params:
...
class JavaModel(JavaTransformer, Model):
    ...
    def __init__(self, java_model=None):
        ...
        MLReader (in pyspark.mlmanager.util) to depend on these wrappers, but
        these wrappers depend on pyspark.mlmanager.util (both directly and via
        other ML classes).
        """
