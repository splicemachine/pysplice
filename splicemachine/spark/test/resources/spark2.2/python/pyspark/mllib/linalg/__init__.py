...
class Vector(object):
    ...
    def asML(self):
        ...
        :return: :py:class:`pyspark.mlflow_support.linalg.Vector`
        """
        raise NotImplementedError
...
class DenseVector(Vector):
    ...
    def asML(self):
        ...
        :return: :py:class:`pyspark.mlflow_support.linalg.DenseVector`
...
class SparseVector(Vector):
    ...
    def asML(self):
        ...
        :return: :py:class:`pyspark.mlflow_support.linalg.SparseVector`
...
class Vectors(object):
    ...
    def fromML(vec):
        ...
        :param vec: a :py:class:`pyspark.mlflow_support.linalg.Vector`
...
class DenseMatrix(Matrix):
    ...
    def asML(self):
        ...
        :return: :py:class:`pyspark.mlflow_support.linalg.DenseMatrix`
...
class SparseMatrix(Matrix):
    ...
    def asML(self):
        ...
        :return: :py:class:`pyspark.mlflow_support.linalg.SparseMatrix`
...
class Matrices(object):
    ...
    def fromML(mat):
        ...
        :param mat: a :py:class:`pyspark.mlflow_support.linalg.Matrix`
