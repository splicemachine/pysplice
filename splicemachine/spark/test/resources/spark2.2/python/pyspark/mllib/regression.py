...
class LinearRegressionWithSGD(object):
    """
    .. versionadded:: 0.9.0
    .. note:: Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression.
    """
    @classmethod
    @since("0.9.0")
    def train(cls, data, iterations=100, step=1.0, miniBatchFraction=1.0,
        ...
        :param convergenceTol:
          ...
          (default: 0.001)
        """
        warnings.warn("Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression.")
...
class LassoWithSGD(object):
    """
    .. versionadded:: 0.9.0
    .. note:: Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression with elasticNetParam = 1.0.
    ...
    def train(cls, data, iterations=100, step=1.0, regParam=0.01,
        ...
        """
        warnings.warn(
            "Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression with elasticNetParam = 1.0. "
            "Note the default regParam is 0.01 for LassoWithSGD, but is 0.0 for LinearRegression.")
...
class RidgeRegressionWithSGD(object):
    """
    .. versionadded:: 0.9.0
    .. note:: Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression with elasticNetParam = 0.0.
    ...
    def train(cls, data, iterations=100, step=1.0, regParam=0.01,
        ...
        """
        warnings.warn(
            "Deprecated in 2.0.0. Use mlflow_support.regression.LinearRegression with elasticNetParam = 0.0. "
            "Note the default regParam is 0.01 for RidgeRegressionWithSGD, but is 0.0 for "
            "LinearRegression.")
